package com.example.opencv.basic.together;
...
public class SalonUseBlurAddWeighted {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SalonUseBlurAddWeighted window = new SalonUseBlurAddWeighted();
     ...
     */
    public SalonUseBlurAddWeighted() {
        initialize();
    }
    ...
    private void initialize() {
        final Mat source1 = Imgcodecs.imread("C:\\opencv-data//lena.jpg");
        final Mat source2 = Imgcodecs.imread("C:\\opencv-data//lena.jpg");
