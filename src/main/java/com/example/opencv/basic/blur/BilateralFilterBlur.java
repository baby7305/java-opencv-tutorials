package com.example.opencv.basic.blur;
...
public class BilateralFilterBlur {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    BilateralFilterBlur window = new BilateralFilterBlur();
    ...
    private void initialize() {
        ...
        frmjavaSwing.setTitle("bilateralFilter模糊練習");
