package com.example.opencv.basic.threshold;
...
public class AdaptiveThreshold {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AdaptiveThreshold window = new AdaptiveThreshold();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//lena-gray.jpg", CvType.CV_8UC1);

        BufferedImage image = matToBufferedImage(source);

        frmjavaSwing = new JFrame();
        frmjavaSwing.setTitle("opencv adaptiveThreshold練習");
