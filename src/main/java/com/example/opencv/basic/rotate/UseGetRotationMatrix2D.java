package com.example.opencv.basic.rotate;
...
public class UseGetRotationMatrix2D {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    UseGetRotationMatrix2D window = new UseGetRotationMatrix2D();
    ...
    private void initialize() {
        ...
        frmjavaSwing.setTitle("opencv角度旋轉練習");
