...
public class FlannBaseAndHomography {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FlannBaseAndHomography window = new FlannBaseAndHomography();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//stuff.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
        final Mat object = Imgcodecs.imread("C:\\opencv-data//stuff-b.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
    ...
    public Mat Features2D() {
        String object_filename = "C:\\opencv-data//stuff-b.jpg";
        String scene_filename = "C:\\opencv-data//stuff.jpg";
