...
public class CornerEigenValsAndCornerMinEigenVal {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CornerEigenValsAndCornerMinEigenVal window = new CornerEigenValsAndCornerMinEigenVal();
     ...
     */
    public CornerEigenValsAndCornerMinEigenVal() {
        initialize();
    }
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0734.jpg");
    ...
    public Mat myHarris(double myHarrisQualityLevel) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0734.jpg");
        // 設置參數
        int blockSize = 3;
        int apertureSize = 3;
