package com.example.opencv.feature.undistort;
...
public class UndistortForArt {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    UndistortForArt window = new UndistortForArt();
    ...
    public Mat matConvertTo(double alpha, double beta) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//005.jpg");
        Mat source1 = Imgcodecs.imread("C:\\opencv-data//lena.jpg");
