package com.example.opencv.feature.chessBoard;
...
public class FindChessboardCorners {
    static {
    ...
    public static void main(String[] args) {
        try {
            Mat source = Imgcodecs.imread("C:\\opencv-data//002.jpg",
            ...
            if (found) {
                ...
                Imgcodecs.imwrite("C:\\opencv-data//test-Calib3d-2.jpg", source);
