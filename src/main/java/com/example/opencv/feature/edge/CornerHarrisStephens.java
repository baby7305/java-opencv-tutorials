package com.example.opencv.feature.edge;
...
public class CornerHarrisStephens {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CornerHarrisStephens window = new CornerHarrisStephens();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//lena.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
    ...
    public Mat Harris(int blockSize, int ksize, double k) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//lena.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
