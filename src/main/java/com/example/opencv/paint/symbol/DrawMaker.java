package com.example.opencv.paint.symbol;
...
public class DrawMaker {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    DrawMaker window = new DrawMaker();
    ...
    private void initialize() {
        ...
        frmjavaSwing.setTitle("opencv 畫特殊符號練習");
    ...
    public Mat paint(int marker) {
        ...
        Mat source = Imgcodecs.imread("C:\\opencv-data//IMG_1017.jpg");
