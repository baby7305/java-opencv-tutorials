package com.example.opencv.paint.emboss;
...
public class EmbossForRectangle {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    EmbossForRectangle window = new EmbossForRectangle();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0836.jpg");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if (getEmbossArea1() != null) {
                    ...
                    Mat source1 = Imgcodecs.imread("C:\\opencv-data//DSC_0836.jpg");
                    //再把小圖copy到大圖
                    //Area1
    ...
    public Mat paintPoint(int x, int y) {
        Mat src = Imgcodecs.imread("C:\\opencv-data//DSC_0836.jpg");
    ...
    public void getRoiAndEmboss() {
        ...
        if (getSecondX() > 0 && getSecondY() > 0) {
            Mat source =
                    Imgcodecs.imread("C:\\opencv-data//DSC_0836.jpg");
