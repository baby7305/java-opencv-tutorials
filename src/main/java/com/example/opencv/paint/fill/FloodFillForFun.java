...
public class FloodFillForFun {
    static {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
    }

    private JFrame frmOpencv;
    private Mat paintMat = Imgcodecs.imread("C:\\opencv-data//floodFill-template.png");
    private Color color;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FloodFillForFun window = new FloodFillForFun();
    ...
    private void initialize() {
        ...
        btnNewButton.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent arg0) {
                paintMat = Imgcodecs.imread("C:\\opencv-data//floodFill-template.png");
    ...
    public void save(Mat src) {
        Imgcodecs.imwrite("C:\\opencv-data//floodFill.jpg", src);
    }
