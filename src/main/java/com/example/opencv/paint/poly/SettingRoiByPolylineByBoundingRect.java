package com.example.opencv.paint.poly;
...
public class SettingRoiByPolylineByBoundingRect {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SettingRoiByPolylineByBoundingRect window = new SettingRoiByPolylineByBoundingRect();
     ...
     */
    public SettingRoiByPolylineByBoundingRect() {
        initialize();
    }
