...
public class RectangleCheckInsideByClipLine {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    RectangleCheckInsideByClipLine window = new RectangleCheckInsideByClipLine();
     ...
     */
    public RectangleCheckInsideByClipLine() {
        initialize();
    }
