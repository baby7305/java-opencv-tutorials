...
public class SettingRoiByPolylineIntoAnotherImg {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    SettingRoiByPolylineIntoAnotherImg window = new SettingRoiByPolylineIntoAnotherImg();
     ...
     */
    public SettingRoiByPolylineIntoAnotherImg() {
        initialize();
    }
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0227.jpg");
        final Mat rightImg = Imgcodecs.imread("C:\\opencv-data//DSC_0250.jpg");
        ...
        sliderX.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                Mat currentRightImg = Imgcodecs.imread("C:\\opencv-data//DSC_0250.jpg");
    ...
    public Mat paintPointAndPolylines(int x, int y) {
        Mat src = Imgcodecs.imread("C:\\opencv-data//DSC_0227.jpg");
