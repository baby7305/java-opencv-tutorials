...
public class RoiForRectangle {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    RoiForRectangle window = new RoiForRectangle();
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (getMatWantToSave() != null) {
                    Imgcodecs.imwrite("C:\\opencv-data//DSC_0625-subImage.jpg", getMatWantToSave());
                } else {
    ...
    public Mat getRoi() {
        ...
        if (getSecondX() > 0 && getSecondY() > 0) {
            Mat source =
                    Imgcodecs.imread("C:\\opencv-data//DSC_0625.jpg");
