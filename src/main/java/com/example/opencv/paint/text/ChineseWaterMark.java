...
public class ChineseWaterMark {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ChineseWaterMark window = new ChineseWaterMark();
     ...
     * @throws IOException
     */
    public ChineseWaterMark() throws IOException {
        initialize();
    }
    ...
    private void initialize() throws IOException {
        Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0597.jpg");
        ...
        btnNewButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                if (image != null) {
                    try {
                        ImageIO.write(image, "png", new File("C:\\opencv-data//DSC_0597_watremark.png"));
                    } catch (IOException e) {
