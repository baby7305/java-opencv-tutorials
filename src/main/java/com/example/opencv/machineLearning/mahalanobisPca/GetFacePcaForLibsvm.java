...
public class GetFacePcaForLibsvm {
    static {
    ...
    public static void main(String[] args) {
        ...
        String fileNameTrain = "C:\\opencv-data\\TrainFacePCA.txt";
        String fileNameTest = "C:\\opencv-data\\TestFacePCA.txt";
        ...
        for (int i = 1; i <= 14; i++) {
            for (int j = 1; j < 9; j++) {
                ...
                source = Imgcodecs.imread("C:\\opencv-data//yalefaces//" + i + "-" + j + ".png", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
