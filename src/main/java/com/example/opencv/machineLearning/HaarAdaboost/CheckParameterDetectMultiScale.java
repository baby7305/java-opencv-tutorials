...
public class CheckParameterDetectMultiScale {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CheckParameterDetectMultiScale window = new CheckParameterDetectMultiScale();
     ...
     */
    public CheckParameterDetectMultiScale() {
        initialize();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//testCar1.jpg");
    ...
    public Mat CheckParameter(float minSz, float maxSz) {
        ...
        CascadeClassifier carsDetector = new CascadeClassifier("C:\\opencv-data//cars3.xml");
        MatOfRect carsDetections = new MatOfRect();

        Mat src = Imgcodecs.imread("C:\\opencv-data//testCar1.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
