...
public class KmeanClassificationForImage {
    ...
    public static void main(String[] args) {
        ...
        Mat img = Imgcodecs.imread("C:\\opencv-data//DSC_0027.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
        Mat result = imageKMeans(img, CLUSTERS, MAX_ITER);


        Imgcodecs.imwrite("C:\\opencv-data//kmean-reduceColor.jpg", result);
