...
public class RandomForestForOnlineOCR {
    static {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    RandomForestForOnlineOCR window = new RandomForestForOnlineOCR();
     ...
     */
    public RandomForestForOnlineOCR() {
        initialize();
    }
    ...
    private void initialize() {
        ...
        JButton btnMLpredict = new JButton("隨機森林預測");
