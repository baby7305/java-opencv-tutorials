package com.example.opencv.advance.circular;
...
public class LogPolar {
    ...
    private void initialize() {
        ...
        final Mat source = Imgcodecs.imread("C:\\opencv-data//linearPolar_test.jpg");

        BufferedImage image = matToBufferedImage(source);

        frmjavaSwing = new JFrame();
        frmjavaSwing.setTitle("LogPolar處理練習");
    ...
    public Mat LinearPolar(double M, int flag) {
        ...
        Mat source = Imgcodecs.imread("C:\\opencv-data//linearPolar_test.jpg");
        Mat dst = new Mat();
