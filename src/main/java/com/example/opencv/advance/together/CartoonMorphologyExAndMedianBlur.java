...
public class CartoonMorphologyExAndMedianBlur {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CartoonMorphologyExAndMedianBlur window = new CartoonMorphologyExAndMedianBlur();
     ...
     */
    public CartoonMorphologyExAndMedianBlur() {
        initialize();
    }
