package com.example.opencv.other.fourier;
...
public class Dft {
    ...
    public static void main(String[] args) {
        try {
            Mat source = Imgcodecs.imread("C:\\opencv-data//lena.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
            ...
            Imgcodecs.imwrite("C:\\opencv-data//lena-dft.jpg", mag);
            //main end
        } catch (Exception e) {
