...
public class Subdiv2dMakeDelaunayForFace {
    static {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
    }

    public static void main(String[] args) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//obama.jpg");
        ...
        Imgcodecs.imwrite("C:\\opencv-data//Subdiv2dMakeDelaunayForObamaFace.jpg", source);
