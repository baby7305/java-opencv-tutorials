package com.example.opencv.other.subdiv2D;
...
public class Subdiv2dMakeVoronoiAndDelaunayTriangle {
    static {
    ...
    public static void main(String[] args) {
        ...
        Imgcodecs.imwrite("C:\\opencv-data//Subdiv2dMakeVoronoi.jpg", img1);
        ...
        Imgcodecs.imwrite("C:\\opencv-data//Subdiv2dMakeTriangle.jpg", img2);
