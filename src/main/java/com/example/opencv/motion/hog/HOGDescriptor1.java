package com.example.opencv.motion.hog;
...
public class HOGDescriptor1 {
    static {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
    }

    public static void main(String arg[]) {
        VideoCapture capture = new VideoCapture("C:\\opencv-data//768x576.avi");
    ...
    public static Mat detect(Mat inputframe) {
        ...
        // 0.2, false, 64);
        final org.opencv.objdetect.HOGDescriptor hog = new org.opencv.objdetect.HOGDescriptor();
        final MatOfFloat descriptors = org.opencv.objdetect.HOGDescriptor.getDefaultPeopleDetector();
