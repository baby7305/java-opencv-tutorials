...
public class UseEqualizeHistWithAddWeightedForRGB {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    UseEqualizeHistWithAddWeightedForRGB window = new UseEqualizeHistWithAddWeightedForRGB();
     ...
     */
    public UseEqualizeHistWithAddWeightedForRGB() {
        initialize();
    }
