package com.example.opencv.camera.nonPhotorealisticRendering;
...
public class PencilSketch {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    PencilSketch window = new PencilSketch();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0704.jpg");

        BufferedImage image = matToBufferedImage(source);

        frmjavaSwing = new JFrame();
        frmjavaSwing.setTitle("opencv pencilSketch 處理練習");
    ...
    public Mat[] PencilSketch(float sigma_s, float sigma_r, float shade_factor) {
        ...
        Mat src = Imgcodecs.imread("C:\\opencv-data//DSC_0704.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
        Mat dst2 = new Mat();
        Mat dst1 = new Mat();
