...
public class Stylization {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Stylization window = new Stylization();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0718.jpg");

        BufferedImage image = matToBufferedImage(source);

        frmjavaSwing = new JFrame();
        frmjavaSwing.setTitle("opencv stylization 處理練習");
    ...
    public Mat Stylization(float sigma_s, float sigma_r) {
        Mat src = Imgcodecs.imread("C:\\opencv-data//DSC_0718.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
