...
public class TextureFlattening {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    TextureFlattening window = new TextureFlattening();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0679.jpg");

        BufferedImage image = matToBufferedImage(source);

        frmjavaSwing = new JFrame();
        frmjavaSwing.setTitle("opencv Texture Flattening處理練習");
    ...
    public Mat TextureFlattening(float low_threshold, float high_threshold, int kernel_size) {
        ...
        Mat src = Imgcodecs.imread("C:\\opencv-data//DSC_0679.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
