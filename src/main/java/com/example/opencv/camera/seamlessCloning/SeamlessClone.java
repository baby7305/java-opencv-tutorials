package com.example.opencv.camera.seamlessCloning;
...
public class SeamlessClone {
    public static void main(String[] args) {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        Mat src1 = Imgcodecs.imread("C:\\opencv-data//monster.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
        Mat dst1 = Imgcodecs.imread("C:\\opencv-data//DSCN3629s.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);

        Mat src2 = Imgcodecs.imread("C:\\opencv-data//monster-bg-less.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);

        Mat src3 = Imgcodecs.imread("C:\\opencv-data//IloveOpencv-s.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
        Mat dst3 = Imgcodecs.imread("C:\\opencv-data//wood2.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);

        Mat src4 = Imgcodecs.imread("C:\\opencv-data//IloveOpencv-bg-gray.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
...
//	        }
        ...
        // Save results
        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-normalClone-LakeMonster.jpg", normal_clone1);
        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-MixedClone-LakeMonster.jpg", mixed_clone1);

        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-normalClone-LakeMonster-bgLess.jpg", normal_clone2);
        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-MixedClone-LakeMonster-bgLess.jpg", mixed_clone2);

        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-normalClone-iloveCv.jpg", normal_clone3);
        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-MixedClone-iloveCv.jpg", mixed_clone3);

        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-normalClone-iloveCv2.jpg", normal_clone4);
        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-MixedClone-iloveCv2.jpg", mixed_clone4);
    }
