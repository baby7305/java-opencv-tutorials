...
public class SeamlessCloneTestBg {
    public static void main(String[] args) {
        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);

        Mat src3 = Imgcodecs.imread("C:\\opencv-data//IloveOpencv-gbg.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
        ...
        Imgcodecs.imwrite("C:\\opencv-data//SeamlessClone-MixedClone-iloveCv-testBG.jpg", mixed_clone3);
