...
public class IlluminationChange {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    IlluminationChange window = new IlluminationChange();
    ...
    private void initialize() {
        ...
        frmjavaSwing.setTitle("opencv illuminationChange處理練習");
    ...
    public Mat illuminationChange(float alpha, float beta) {
        Mat src = Imgcodecs.imread("C:\\opencv-data//lena.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
