...
public class CombineTwoPicBySeamlessClone {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CombineTwoPicBySeamlessClone window = new CombineTwoPicBySeamlessClone();
     ...
     */
    public CombineTwoPicBySeamlessClone() {
        initialize();
    }
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0897.jpg");
        final Mat rightImg = Imgcodecs.imread("C:\\opencv-data//DSC_0230.jpg");
        ...
        sliderX.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                Mat currentRightImg = Imgcodecs.imread("C:\\opencv-data//DSC_0230.jpg");
...
//					    Photo.seamlessClone(roi,rightImg, src_mask, new Point(150,150), mixed_clone,  Photo.MIXED_CLONE);
    ...
    public Mat paintPointAndPolylines(int x, int y) {
        Mat src = Imgcodecs.imread("C:\\opencv-data//DSC_0897.jpg");
