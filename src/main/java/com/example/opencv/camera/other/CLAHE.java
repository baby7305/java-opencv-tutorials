...
public class CLAHE {
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//scene_l.bmp", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
    ...
    public Mat CLAHE(double clipLimit, double tileGridSize) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//scene_l.bmp", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        Mat dst = new Mat();
        org.opencv.imgproc.CLAHE clahe = Imgproc.createCLAHE(clipLimit, new Size(tileGridSize, tileGridSize));
