package com.example.opencv.camera.hdr;
...
public class HDR {
    public static void main(String[] args) {
        try {
            ...
            Mat source1 = Imgcodecs.imread("C:\\opencv-data//HDRmantis1.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source2 = Imgcodecs.imread("C:\\opencv-data//HDRmantis2.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source3 = Imgcodecs.imread("C:\\opencv-data//HDRmantis3.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source4 = Imgcodecs.imread("C:\\opencv-data//HDRmantis4.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source5 = Imgcodecs.imread("C:\\opencv-data//HDRmantis5.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source6 = Imgcodecs.imread("C:\\opencv-data//HDRmantis6.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
            Mat source7 = Imgcodecs.imread("C:\\opencv-data//HDRmantis7.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
...
//          alignMTB.process(listMat, alignMTBMatList, times, response);
            ...
            //Write results
            Imgcodecs.imwrite("C:\\opencv-data//CalibrateDebevec-mantis-ldr.jpg", ldr);
            Imgcodecs.imwrite("C:\\opencv-data//CalibrateDebevec-mantis-ldrRobertson.jpg", ldrRobertson);

            Imgcodecs.imwrite("C:\\opencv-data//CalibrateDebevec-mantis-fusion.jpg", fusion);
            Imgcodecs.imwrite("C:\\opencv-data//CalibrateDebevec-mantis-mergeRobertsonMat.jpg", mergeRobertsonMat);

            //Imgcodecs.imwrite("C://opencv3.1//samples//CalibrateDebevec-hdr.hdr", hdr);
            Imgcodecs.imwrite("C:\\opencv-data//CalibrateDebevec-mantis-tonemapMat.jpg", tonemapMat);
            Imgcodecs.imwrite("C:\\opencv-data//CalibrateDebevec-mantis-tonemapDragoMat.jpg", tonemapDragoMat);
            Imgcodecs.imwrite("C:\\opencv-data//CalibrateDebevec-mantis-tonemapMantiukMat.jpg", tonemapMantiukMat);
            Imgcodecs.imwrite("C:\\opencv-data//CalibrateDebevec-mantis-tonemapReinhardMat.jpg", tonemapReinhardMat);
