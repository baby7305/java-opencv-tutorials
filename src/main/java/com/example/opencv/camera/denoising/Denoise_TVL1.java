...
public class Denoise_TVL1 {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Denoise_TVL1 window = new Denoise_TVL1();
    ...
    private void initialize() {
        ...
        frmjavaSwing.setTitle("opencv denoise_TVL1處理練習");
    ...
    public Mat Denoise(Mat source, int lambda, int niters) {
        Mat im = Imgcodecs.imread("C:\\opencv-data//lena.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        Mat im1 = Imgcodecs.imread("C:\\opencv-data//lena1.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        Mat im2 = Imgcodecs.imread("C:\\opencv-data//lena2.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
