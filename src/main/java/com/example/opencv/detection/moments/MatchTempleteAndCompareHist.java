...
public class MatchTempleteAndCompareHist {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    MatchTempleteAndCompareHist window = new MatchTempleteAndCompareHist();
     ...
     */
    public MatchTempleteAndCompareHist() {
        initialize();
    ...
    private void initialize() {
        ...
        lblNewLabel_2.setIcon(new ImageIcon("C:\\opencv-data//goat-template1.jpg"));
        ...
        lblNewLabel_ladybug.setIcon(new ImageIcon("C:\\opencv-data//ladybug.jpg"));
        ...
        slider_method2.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                Mat template = Imgcodecs.imread("C:\\opencv-data//ladybug.jpg");
        ...
        slider_method.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent arg0) {
                ...
                Mat src = Imgcodecs.imread("C:\\opencv-data//DSC_0864.jpg");
                Mat template = Imgcodecs.imread("C:\\opencv-data//goat-template1.jpg");
