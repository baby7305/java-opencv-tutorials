...
public class Moments {
    ...
    private void initialize() {
        Mat source = Imgcodecs.imread("C:\\opencv-data//moment-test1.png",
    ...
    public Mat findContours(int i) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//moment-test1.png", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        org.opencv.imgproc.Moments moments = new org.opencv.imgproc.Moments();
