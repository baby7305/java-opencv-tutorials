...
public class CheckHSVfromPic {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CheckHSVfromPic window = new CheckHSVfromPic();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0691.jpg");
    ...
    public Mat matConvertTo(double Hmin, double Hmax, double Smin, double Smax, double Vmin, double Vmax) {
        Mat source2 = Imgcodecs.imread("C:\\opencv-data//DSC_0691.jpg");
