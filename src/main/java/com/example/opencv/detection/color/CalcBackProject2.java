...
public class CalcBackProject2 {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CalcBackProject2 window = new CalcBackProject2();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//palm2.jpg");
    ...
    public Mat BackProject(int threshold1) {
        int bins = 30;
        Mat source2 = Imgcodecs.imread("C:\\opencv-data//palm2.jpg");
        Mat handle = new Mat();
