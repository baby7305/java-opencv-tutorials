package com.example.opencv.detection.color;
...
public class FindColorByRGB {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FindColorByRGB window = new FindColorByRGB();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//color2.png");

        BufferedImage image = matToBufferedImage(source);

        frmjavaSwing = new JFrame();
        frmjavaSwing.setTitle("opencv 顏色辨識練習");
    ...
    public Mat findColor(int B, int G, int R) {
        Mat source2 = Imgcodecs.imread("C:\\opencv-data//color2.png");
