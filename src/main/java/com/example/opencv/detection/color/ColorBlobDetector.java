...
public class ColorBlobDetector {
    ...
    public void ColorBlobDetector() {
        ...
        Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0724.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
        ...
        Imgcodecs.imwrite("C:\\opencv-data//colorBlobdector1.jpg", source);
    ...
    public static void main(String[] args) {
        ...
        new ColorBlobDetector().ColorBlobDetector();
    }
