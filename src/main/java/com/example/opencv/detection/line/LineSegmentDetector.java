package com.example.opencv.detection.line;
...
public class LineSegmentDetector {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    LineSegmentDetector window = new LineSegmentDetector();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0763.jpg");
    ...
    public Mat LineSegmentDetector(int refine, float scale, float sigma_scale, float quant, float ang_th, int log_eps, float density_th, int n_bits) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//DSC_0763.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        Mat Line = new Mat();
