...
public class FindApLocationInDesktop {
    static {
    ...
    public static void main(String[] args) throws AWTException {
        ...
        Mat template = Imgcodecs.imread("C:\\opencv-data//wordTitle.png");
        ...
        Imgcodecs.imwrite("C:\\opencv-data//whereIsTheWord.png", findResult);
    }
