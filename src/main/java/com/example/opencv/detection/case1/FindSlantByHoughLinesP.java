...
public class FindSlantByHoughLinesP {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FindSlantByHoughLinesP window = new FindSlantByHoughLinesP();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//IMAG0423.jpg");
    ...
    public Mat HoughLine(int threshold, double minLineLength, double maxLineGap) {
        ...
        Mat src = Imgcodecs.imread("C:\\opencv-data//IMAG0423.jpg");
    ...
    public Mat matConvertTo() {
        Mat source2 = Imgcodecs.imread("C:\\opencv-data//IMAG0423.jpg");
