package com.example.opencv.detection.case1;
...
public class FindBrokenByShiTomasi {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FindBrokenByShiTomasi window = new FindBrokenByShiTomasi();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//IMAG0424.jpg");
    ...
    public Mat ShiTomasi(int maxCorners, double qualityLevel, double minDistance) {
        ...
        Mat source = Imgcodecs.imread("C:\\opencv-data//IMAG0424.jpg", Imgcodecs.CV_LOAD_IMAGE_COLOR);
    ...
    public Mat matConvertTo() {
        Mat source2 = Imgcodecs.imread("C:\\opencv-data//IMAG0424.jpg");
