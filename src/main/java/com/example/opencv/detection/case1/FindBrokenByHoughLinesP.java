...
public class FindBrokenByHoughLinesP {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FindBrokenByHoughLinesP window = new FindBrokenByHoughLinesP();
     ...
     */
    public FindBrokenByHoughLinesP() {
        initialize();
    }
    ...
    public Mat HoughLine(int threshold, double minLineLength, double maxLineGap) {
        ...
        Mat src = Imgcodecs.imread("C:\\opencv-data//IMAG0424.jpg");
