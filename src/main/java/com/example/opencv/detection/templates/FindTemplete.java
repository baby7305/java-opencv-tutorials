...
public class FindTemplete {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FindTemplete window = new FindTemplete();
    ...
    private void initialize() {
        ...
        final Mat template = Imgcodecs.imread("C:\\opencv-data//goat-template1.jpg");
    ...
    public Mat findTemplete(Mat src, Mat template, int match_method) {
        ...
        Imgcodecs.imwrite("C:\\opencv-data//matchTemplate-result.jpg", result);
