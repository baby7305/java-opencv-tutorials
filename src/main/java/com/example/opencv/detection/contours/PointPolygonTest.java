...
public class PointPolygonTest {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    PointPolygonTest window = new PointPolygonTest();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//shape-sample.jpg");
        String showData = "";
    ...
    public Mat isInner(double threshold1, int X, int Y) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//shape-sample.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
