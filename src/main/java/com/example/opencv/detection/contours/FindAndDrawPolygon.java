...
public class FindAndDrawPolygon {
    static {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    FindAndDrawPolygon window = new FindAndDrawPolygon();
    ...
    public Mat FindAndDrawPolygon(double threshold1) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//palm_p.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
