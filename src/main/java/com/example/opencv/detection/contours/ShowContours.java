...
public class ShowContours {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ShowContours window = new ShowContours();
    ...
    private void initialize() {
        Mat source = Imgcodecs.imread("C:\\opencv-data//ContoursTest.png",
    ...
    public Mat findContours(int i, int mode, int method) {
        ...
        Mat source = Imgcodecs.imread("C:\\opencv-data//ContoursTest.png", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
