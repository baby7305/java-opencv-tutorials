package com.example.opencv.detection.tangent;
...
public class FitLine1 {
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//fitline_test1.jpg");
    ...
    public Mat FindFitLine(double threshold1, int distType) {
        Mat source = Imgcodecs.imread("C:\\opencv-data//fitline_test1.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        Mat srcClone = Imgcodecs.imread("C:\\opencv-data//fitline_test1.jpg");
        Mat line = new Mat();
