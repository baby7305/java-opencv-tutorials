package com.example.opencv.detection.circle;
...
public class HoughCircle {
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    HoughCircle window = new HoughCircle();
    ...
    private void initialize() {
        final Mat source = Imgcodecs.imread("C:\\opencv-data//coin.jpg");
    ...
    public Mat HoughCircle(double GBK, double threshold1, int method, double dp, double minDist, double param1, double param2, int minRadius, int maxRadius) {
        Mat source1 = Imgcodecs.imread("C:\\opencv-data//coin.jpg");
        Mat source = Imgcodecs.imread("C:\\opencv-data//coin.jpg", Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
